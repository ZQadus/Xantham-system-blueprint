...
Companion file to `xantham-system-v33.md`. This file contains every template body the install wizard copies verbatim into the user's filesystem (scripts, hooks, skills, agent configs, memory seeds, doc bodies).
...
- Inside every generated launchd plist under `~/Library/LaunchAgents/com.{{orchestrator_lower}}.*.plist`: an XML comment line `<!-- XANTHAM-SENTINEL: launchd-plist-v31 -->` inside `<dict>`. The plist template in xantham-system-v33.md already carries this comment.
...
# Wire via Task Scheduler on Windows. Example trigger in xantham-system-v33.md.
#
# State:
...
BLUEPRINT_FILES=(
  "xantham-system-v33.md"
  "xantham-templates-v33.md"
  "XANTHAM-AUTOSYNC.md"
)
